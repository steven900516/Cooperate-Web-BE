...
public class CardController {
    ...
    public JsonResult setCardDeadline(@RequestBody CardDateParam cardDateParam, @PathVariable Long cardId) throws InterruptedException {
        // 已改
    ...
    public JsonResult<List<UserVo>> setExecutor(@RequestParam("userId") Long userId, @PathVariable Long cardId) throws InterruptedException {
        // 已改
