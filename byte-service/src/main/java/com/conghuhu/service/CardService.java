...
public interface CardService extends IService<Card> {
     ...
     * @return
     */
    JsonResult setCardDeadline(CardDateParam cardDateParam, Long cardId) throws InterruptedException;
     ...
     * @return
     */
    JsonResult setExecutor(Long userId, Long cardId) throws InterruptedException;
